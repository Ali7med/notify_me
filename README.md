...
### ⚙️ **إعدادات متقدمة**
**تصميم جديد بالتبويبات (4 تبويبات):**
...
- أزرار Quick Select: Google DNS، Cloudflare، OpenDNS
- التحقق من صحة IP

#### 🔔 **Notifications (الإشعارات)**
- تفعيل/إيقاف Toast Notifications
- تفعيل/إيقاف Sound Alerts
- Tip Box توضيحي
- تحكم مستقل لكل نوع
...
- شروحات تفصيلية لكل إعداد
- **🚀 Start with Windows**: بدء تلقائي مع النظام
...
- تفعيل/تعطيل من الإعدادات (بشكل مستقل عن Toast)
...
| Toast Notifications | الإشعارات المنبثقة | مُفعَّل |
| Sound Notifications | الإشعارات الصوتية | مُفعَّل |
| Start with Windows | البدء التلقائي مع Windows | معطل |
...
- [x] **المرحلة 5**: الإشعارات الصوتية ✅
- [x] **المرحلة 6**: التحكم في الإشعارات (Toast & Sound) ✅
- [x] **المرحلة 7**: إعادة تصميم واجهة الإعدادات بالتبويبات ✅
- [x] **المرحلة 8**: البدء التلقائي مع Windows ✅
- [ ] **المرحلة 9**: وضع Do Not Disturb
- [ ] **المرحلة 10**: دعم تعدد اللغات (عربي/إنجليزي)
- [ ] **المرحلة 11**: تحسينات الأداء
